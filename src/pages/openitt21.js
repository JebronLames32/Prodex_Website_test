...
class Openiit21 extends React.Component{
    render(){
        return  <main id="main">
...
<!-- ======= Portfolio Details Section ======= --> */}
          ...
          <div class="container">
            ...
            <div class="portfolio-details-container">
              ...
              {/* <!-- <div class="owl-carousel portfolio-details-carousel"> -->
                <!-- <img src="assets/img/portfolio/openiit1.jpg" class="img-fluid" alt=""> -->
    ...
    {/* 
            ...
            <div class="portfolio-description">
              <h2>Open IIT 2021 (Category-Product Design)</h2>
              <p>
                ...
                the 2020 edition and our Team ProDex emerged victorious by securing 2nd position(silver) and 3rd position(bronze) overall, carrying on our legacy.
              </p>
            </div>
